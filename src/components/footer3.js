      ...
      <div className="footer3-max-width thq-section-max-width">
        <div className="footer3-content">
          <div className="footer3-logo">
            <h1 className="footer3-text1">
              {props.heading ?? (
                <Fragment>
                  <span className="footer3-text6">Date contact:</span>
                </Fragment>
              )}
            </h1>
            <h1 className="footer3-text2">
              {props.heading1 ?? (
                <Fragment>
            ...
            <h1 className="footer3-text3">
              {props.heading2 ?? (
                <Fragment>
                  <span className="footer3-text4">Telefon:0751288856</span>
                </Fragment>
              )}
            </h1>
          </div>
          <div className="footer3-container">
            <div className="footer3-social-links">
              ...
              <svg
                ...
                className="footer3-icon7 thq-icon-small"
              >
